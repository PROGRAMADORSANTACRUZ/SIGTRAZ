...
const EMPRESAS = [
  ...
  'Cristian Serrano Millan',
  'Karol Serrano Millan',
            ...
            <div className="flex items-center gap-4 border-b border-brand-100 bg-brand-50 px-6 py-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900">
                  {editandoId ? 'Editar vinculacion' : 'Nueva vinculacion'} de
                  cliente
                </h3>
          ...
          <Seccion numero={8} titulo="Autorizaciones y declaraciones">
            <div className="space-y-3">
              ...
              <Check
                ...
                texto="Declaro bajo la gravedad de juramento que el origen de los fondos es licito y que la informacion es veraz (Circular 100-000016 de 2020 - SAGRILAFT)."
              />
            </div>
          </Seccion>
